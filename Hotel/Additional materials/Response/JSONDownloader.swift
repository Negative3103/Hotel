...
struct JSONDownloader {
    ...
    func jsonTask(url: String? = nil, requestMethod: HTTPRequestMethod, headers: [String : String]? = nil, parameters: [String : Any]? = nil, completionHandler completion: @escaping JSONTaskCompletionHandler) {
